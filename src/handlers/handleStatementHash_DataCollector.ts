...
export interface handleStatementHash_DataCollector {
  beginTime?: string;
  endTime?: string;
  statementHash?: string;
  maxResultLines?: string;
  timeUnit?: string;
}

export async function handleStatementHash_DataCollector(params: handleStatementHash_DataCollector = {}): Promise<ToolResponse> {
  try {
    const beginTime = getOrDefault(params.beginTime, `'C-M5'`);
    const endTime = getOrDefault(params.endTime, `'C'`);
    const statementHash = getOrDefault(params.statementHash, `'%'`);
    const maxResultLines = getOrDefault(params.maxResultLines, `'30'`);

    // timeUnit 제한 및 자동 포맷
    const timeUnit = getOrDefault(params.timeUnit, `'MS'`);
...
( SELECT
    ...
    MAP(L.DETAIL_LINE, 1, IFNULL(E.OPERATOR_PROPERTIES, ''), '') OPERATOR_PROPERTIES,
    ...
    GREATEST(19, MAX(LENGTH(E.OPERATOR_PROPERTIES)) OVER ()) OPERATOR_PROP_LEN
  FROM
  ...
  WHERE
    ...
    LENGTH(E.OPERATOR_DETAILS) > 80 * ( L.DETAIL_LINE - 1 )
)
SELECT
...
( SELECT   10 LINE_NO, '*******************************************' LINE                                                            FROM DUMMY UNION ALL
  ...
  SELECT 3080, RPAD('SNAPSHOT_TIME', 20) || RPAD('HOST', HOST_LEN) || CHAR(32) || LPAD('PLAN_ID', 13) || CHAR(32) || RPAD('ENG', 4) || CHAR(32) || LPAD('EXECUTIONS', 14) || CHAR(32) || 
    LPAD('RECORDS', 14) || CHAR(32) || LPAD('REC_PER_EXEC', 14) || CHAR(32) || LPAD('EXEC_S', 12) || CHAR(32) || LPAD('AVG_EXEC_MS', 13) || CHAR(32) || LPAD('AVG_REC_MS', 12) || CHAR(32) || 
  ...
  SELECT 3090, RPAD('=', 19, '=') || CHAR(32) || RPAD('=', HOST_LEN, '=') || CHAR(32) || LPAD('=', 13, '=') || CHAR(32) || RPAD('=', 4, '=') || CHAR(32) || LPAD('=', 14, '=') || CHAR(32) || 
    LPAD('=', 14, '=') || CHAR(32) || LPAD('=', 14, '=') || CHAR(32) || LPAD('=', 12, '=') || CHAR(32) || LPAD('=', 13, '=') || CHAR(32) || LPAD('=', 12, '=') || CHAR(32) || 
  ...
  SELECT 3310, RPAD('SNP_TIME', 10) || CHAR(32) || RPAD('HOST', HOST_LEN) || CHAR(32) || LPAD('PLAN_ID', 13) || CHAR(32) || RPAD('ENG', 4) || CHAR(32) || LPAD('EXECUTIONS', 14) || CHAR(32) || 
    LPAD('RECORDS', 14) || CHAR(32) || LPAD('REC_PER_EXEC', 14) || CHAR(32) || LPAD('EXEC_S', 12) || CHAR(32) || LPAD('AVG_EXEC_MS', 13) || CHAR(32) || LPAD('AVG_REC_MS', 12) || CHAR(32) || 
    LPAD('PREPARES', 8) || CHAR(32) || LPAD('PREPARE_MS', 11) || CHAR(32) || LPAD('LOCK_S', 10) FROM ( SELECT HOST_LEN FROM BASIS_INFO ) UNION ALL
  SELECT 3320, RPAD('=', 10, '=') || CHAR(32) || RPAD('=', HOST_LEN, '=') || CHAR(32) || LPAD('=', 13, '=')  || CHAR(32) || RPAD('=', 4, '=') || CHAR(32) || LPAD('=', 14, '=') || CHAR(32) || 
    LPAD('=', 14, '=') || CHAR(32) || LPAD('=', 14, '=') || CHAR(32) || LPAD('=', 12, '=') || CHAR(32) || LPAD('=', 13, '=') || CHAR(32) || LPAD('=', 12, '=') || CHAR(32) || 
    LPAD('=', 8, '=') || CHAR(32) || LPAD('=', 11, '=') || CHAR(32) || LPAD('=', 10, '=') FROM ( SELECT HOST_LEN FROM BASIS_INFO ) UNION ALL
  SELECT
    LINE_NO,
    LINE
  FROM
  ( SELECT BI.MAX_RESULT_LINES, ROW_NUMBER () OVER (ORDER BY TO_VARCHAR(C.SERVER_TIMESTAMP, 'YYYY/MM/DD') DESC) ROWNO, 3330 + MIN(C.LINE_NO) / 1000 LINE_NO, RPAD(TO_VARCHAR(C.SERVER_TIMESTAMP, 'YYYY/MM/DD'), 10) || CHAR(32) ||
      ...
      LPAD(TO_DECIMAL(ROUND(SUM(C.TOTAL_LOCK_WAIT_DURATION) / 1000000), 15, 0), 11) LINE
    FROM
      BASIS_INFO BI,
      SQL_CACHE_HISTORY C
    GROUP BY
