import {
  ...
  createErrorResponse,
  ToolResponse,
  // logError, // MCP에서 제공하는 로깅 유틸이 있다면 사용
} from '../lib/utils';
 ...
 */
export async function handleLoadHistory(params: LoadHistoryParams): Promise<ToolResponse> {
...
`;
  ...
  try {
    ...
    return formatQueryResult(result, 'HANA Load History');
  } catch (error) {
