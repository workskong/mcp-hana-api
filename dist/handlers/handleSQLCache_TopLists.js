...
exports.handleSQLCacheTopLists = handleSQLCacheTopLists;
const utils_1 = require("../lib/utils");
async function handleSQLCacheTopLists(params) {
...
( SELECT
  ...
  ( SELECT
      ...
      CASE
        ...
        WHEN MAX(APPLICATION_NAME) = 'com.dynatrace.datasource.SQL' THEN 'DT'
...
( SELECT
    T.STATEMENT_HASH,
    CASE
      WHEN T.STATEMENT_HASH = 'd6fd6678833f9a2e25e7b53239c50e9a' THEN '-- STATISTICS_SCHEDULABLEWRAPPER --'
      ...
      ( SELECT
        ...
        ( SELECT DISTINCT
          ...
          ( SELECT DISTINCT
            ...
            WHERE
            ( TO_VARCHAR(OBJECT_NAME) != '' OR UPPER(TO_VARCHAR(STATEMENT_STRING)) LIKE 'BACKUP%' OR OPERATION = 'CREATE_TABLE' )  
          ) S
        )
        WHERE
          SCHEMA_OBJECT LIKE '%.%'
...
ORDER BY
  LINE_NO
    `;
        ...
        return (0, utils_1.formatQueryResult)(result, 'SQL Cache Top 리스트 조회');
    }
    catch (error) {
        return (0, utils_1.createErrorResponse)(error, 'SQL Cache Top 리스트 조회');
    }
}
